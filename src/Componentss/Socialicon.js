...
function Socialicon() {
  return (
    <>
      <div className="fixed top-72 md:top-56 align-items-center  flex flex-col gap-4 right-3 z-10 ">
                <div className="bg-green-400 p-1 rounded"> <a
                  ...
                  <a href="https://api.whatsapp.com/send?phone=923119265290&text=Hello%20TechCreator%20Team" target='_blank'>
